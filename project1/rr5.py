...
Part 2: Implementation - Round-Robin (Time Slice = 5)

This program simulates the Round-Robin (RR) scheduling algorithm
with a fixed time slice of 5.

Usage: python rr5.py <input_file>
Example: python rr5.py job.txt
"""
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python rr5.py <input_file>")
        sys.exit(1)

    input_filename = sys.argv[1]
    jobs = parse_input_file(input_filename)

    TIME_SLICE = 5  # [cite: 19, 42]
